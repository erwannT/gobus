...
//NewGtfsDao créé une valeur pour la structure GtfsDao
...
// Close fermee la connexion a la base de donnée
func (dao *GtfsDao) Close() {
	dao.db.Close()
}

//FindStop liste les points d'arrets en fonction de la position geo et d'une distance
...
//FindDirections recherche les voyages disponibles entre deux horaires pour un ensemble d'arret
